...
#    cv2.imwrite("unit8_img.jpg", img)
    lines = []
    lines = cv2.HoughLines(img,7,np.pi/360,1800)
...
if __name__ == '__main__':
    ...
    while(i <= knnFrames_size):
        ...
        knn_to_hough_frame(knnFrame_i_path,  frame_i_path, outImg_name)                         # in cwd, creates a "hough_frames" directory and saves ith hough frame as "framei.jpg"
        i += 1
